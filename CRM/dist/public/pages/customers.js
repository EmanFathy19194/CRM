...
export async function renderCustomers(page = pageNumber, search = searchTerm, status = statusFilter) {
    ...
    document.querySelector("#customer-search").addEventListener("input", (event) => { const value = event.target.value; window.setTimeout(() => void renderCustomers(1, value, statusFilter), 250); });
